...
ElevatorSubsystem::ElevatorSubsystem() : 
        ...
        m_pickUpHeight("Elevator Pick Up Height",0.08),
        m_mediumHeight("Elevator Mid-Level Height",0.26),
        m_highHeight("Elevator High-Level Height",0.546757),
        ...
        m_topAutoLimit("Elevator Auto Top Limit",0.546757),
